# nvim-treesitter-queries-odin

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-odin/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-odin/actions/workflows/validate.yml)

Neovim tree-sitter queries for **odin**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-odin",
...
- [ ] Changes are scoped to `odin` — do not include files for other languages
